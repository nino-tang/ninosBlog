...
>  > 注意事项
>  >
>  > > string转换基本类型时，要确保string类型能够转成有效数据，可以吧'123'转换成一个整数，但不能吧"hello"转换成一个整数
...
![image-20220213162614379](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220213162614379.png)
...
5. 案例演示obj.hashCode() [测试 A obj1 = new A(); A obj2 = new A(); A obj3 = obj1]
   ...
   ![image-20220323164744164](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220323164744164.png)
...
* shift+F8（跳出）
  * 跳出方法
* F9（resume，执行到下一个断点）![image-20220324141333874](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220324141333874.png)
...
![image-20220402161426676](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220402161426676.png)

static变量是对象共享的

不管static变量在哪

* static变量是同一个类，所有对象共享
...
4. java执行的程序 参数1 参数2  参数3
   ...
   ![image-20220403184106869](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220403184106869.png)
...
2. 类什么时候被加载？[重要]
   ...
   ![image-20220404151232983](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220404151232983.png)
...
7. 如果外部类和内部类的成员重名时，内部类访问的话，默认遵循就近原则，如果想访问外部类的成员，则可以使用（外部类名.this.成员）去访问
   ...
   ![image-20220409142725630](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220409142725630.png)
...
![image-20220409204654918](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220409204654918.png)
...
![image-20220410224921752](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220410224921752.png)
...
3. @SuppressWarnings：抑制编译器警告
   ...
   2. 可以在@SuppressWarnings{""}中写入希望抑制的警告信息
      ...
      ![image-20220410190809537](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220410190809537.png)
...
![image-20220410203107921](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220410203107921.png)
...
![image-20220411214601035](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220411214601035.png)

![image-20220411215335526](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220411215335526.png)
...
![image-20220412164154544](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220412164154544.png)
...
1. ![image-20220413164815801](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220413164815801.png)

2. 因为integer的原码定义好了从-128-127之间不返回一个对象

   ![image-20220413164729185](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220413164729185.png)
   ...
   ![image-20220413205739995](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220413205739995.png)
...
![image-20220413213320195](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220413213320195.png)
...
![image-20220414101904944](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220414101904944.png)
...
![image-20220414140922725](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220414140922725.png)
...
![image-20220414145929644](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220414145929644.png)
...
![image-20220415090614911](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220415090614911.png)
...
方法一览（均为静态方法）![image-20220415145338171](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220415145338171.png)
...
![image-20220420110144786](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220420110144786.png)
...
![image-20220420163040446](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220420163040446.png)

![image-20220420163624872](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220420163624872.png)

2）双列集合（存放键值对形式的）

![image-20220420163100945](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220420163100945.png)

![image-20220420163609594](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220420163609594.png)
...
![image-20220420165341922](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220420165341922.png)
...
3）Iterator的结构![image-20220420231917444](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220420231917444.png)

4）Iterator仅用于遍历集合，Iterator本身并不存放对象

#### 迭代器的运行原理

![image-20220421160914060](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220421160914060.png)
...
![image-20220429152321935](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220429152321935.png)
...
3）JDK API中Set接口的实现类有![image-20220429173926895](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220429173926895.png)
...
![image-20220430145947382](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220430145947382.png)
...
7. ![image-20220430160350549](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220430160350549.png)
...
3）LinkedHashSet根据元素的hashCode值来决定元素的储存位置，同时使用链表维护元素的次序（图），这使得元素看起来是以插入顺序保存的![image-20220501174705977](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220501174705977.png)

4）LinkedHashSet不允许添加重复元素 

![image-20220502111826275](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220502111826275.png)
...
<img src="https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220503163901620.png" alt="image-20220503163901620" style="zoom:50%;" />
...
![image-20220504165516988](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220504165516988.png)
...
![image-20220506160740866](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220506160740866.png)
...
可以表示数据类型的数据类型![image-20220509171057972](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220509171057972.png)
...
![image-20220509171249826](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220509171249826.png)
...
![image-20220511142709072](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220511142709072.png)

4）<? super A>:支持A类以及A类的父类，不限于直接父类，规定了泛型的下限

![image-20220511142730306](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220511142730306.png)
...
1. 开发一个hello.java文件，输出：老王 is studying java！
   ...
   需注意的事项：记得吧类部分带上public class 带上，不要只写个方法

## 制表符部分

1. ![image-20220204140604059](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220204140604059.png)
...
![image-20220225162131420](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220225162131420.png)

![image-20220225162214945](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220225162214945.png)

1. 3,4,5为春季。6，7，8，为夏季，9,10,11位秋季。12,1,2为冬季
...
![image-20220311132440361](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220311132440361.png)
...
2. 在堆中开辟一个空间，内部存放形参
   ...
   3. 引用类型的话，会将数据存放在常量池，在堆中放入地址。此时堆中的空间才会有赋值
3. 最后再把堆的地址，赋给栈中的p对象引用 (xxx p = new  xxx;)
4. ![image-20220314215432778](https://ninos-img.oss-cn-shanghai.aliyuncs.com/img/image-20220314215432778.png)
